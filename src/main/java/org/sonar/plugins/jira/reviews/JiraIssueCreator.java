 ...
 */
@Properties({@Property(key = JiraConstants.SOAP_BASE_URL_PROPERTY,
    defaultValue = JiraConstants.SOAP_BASE_URL_DEF_VALUE, name = "SOAP base URL",
    description = "Base URL for the SOAP API of the JIRA server", global = true, project = true),
    @Property(key = JiraConstants.REST_BASE_URL_PROPERTY,
        defaultValue = JiraConstants.REST_BASE_URL_DEF_VALUE, name = "REST base URL",
        description = "Base URL for the REST API of the JIRA server", global = true,
        project = true),
    @Property(key = JiraConstants.JIRA_PROJECT_KEY_PROPERTY, defaultValue = "",
        name = "JIRA project key",
        description = "Key of the JIRA project on which the JIRA issues should be created.",
        global = false, project = true),
    @Property(key = JiraConstants.JIRA_INFO_PRIORITY_ID, defaultValue = "5",
    ...
    @Property(key = JiraConstants.JIRA_MINOR_PRIORITY_ID, defaultValue = "4",
        ...
        global = true, project = true, type = PropertyType.INTEGER),
    @Property(key = JiraConstants.JIRA_MAJOR_PRIORITY_ID, defaultValue = "3",
        ...
        global = true, project = true, type = PropertyType.INTEGER),
    @Property(key = JiraConstants.JIRA_CRITICAL_PRIORITY_ID, defaultValue = "2",
        ...
        global = true, project = true, type = PropertyType.INTEGER),
    @Property(key = JiraConstants.JIRA_BLOCKER_PRIORITY_ID, defaultValue = "1",
        ...
        global = true, project = true, type = PropertyType.INTEGER),
    @Property(key = JiraConstants.JIRA_ISSUE_TYPE_ID, defaultValue = "3",
        ...
        global = true, project = true, type = PropertyType.INTEGER),
    @Property(key = JiraConstants.JIRA_ISSUE_COMPONENT_ID, defaultValue = "",
        ...
        global = false, project = true, type = PropertyType.INTEGER),
    @Property(key = JiraConstants.JIRA_ISSUE_SONAR_LABEL, defaultValue = "SONAR",
        name = "Jira label", description = "JIRA label for all sonar issues.", global = true,
        project = true, type = PropertyType.STRING),
    @Property(key = JiraConstants.JIRA_AUTOCREATE_BLOCKER,
        defaultValue = JiraConstants.JIRA_AUTOCREATE_BLOCKER_DEF_VALUE,
        name = JiraConstants.JIRA_AUTOCREATE_BASE_NAME + "Blocker",
        description = JiraConstants.JIRA_AUTOCREATE_BASE_DESC + "Blocker", global = true,
        project = true),
    @Property(key = JiraConstants.JIRA_AUTOCREATE_CRITICAL,
        defaultValue = JiraConstants.JIRA_AUTOCREATE_CRITICAL_DEF_VALUE,
        name = JiraConstants.JIRA_AUTOCREATE_BASE_NAME + "Critical",
        description = JiraConstants.JIRA_AUTOCREATE_BASE_DESC + "Critical", global = true,
        project = true),
    @Property(key = JiraConstants.JIRA_AUTOCREATE_MAJOR,
        defaultValue = JiraConstants.JIRA_AUTOCREATE_MAJOR_DEF_VALUE,
        name = JiraConstants.JIRA_AUTOCREATE_BASE_NAME + "Major",
        description = JiraConstants.JIRA_AUTOCREATE_BASE_DESC + "Major", global = true,
        project = true),
    @Property(key = JiraConstants.JIRA_AUTOCREATE_MINOR,
        defaultValue = JiraConstants.JIRA_AUTOCREATE_MINOR_DEF_VALUE,
        name = JiraConstants.JIRA_AUTOCREATE_BASE_NAME + "Minor",
        description = JiraConstants.JIRA_AUTOCREATE_BASE_DESC + "Minor", global = true,
        project = true),
    @Property(key = JiraConstants.JIRA_AUTOCREATE_INFO,
        defaultValue = JiraConstants.JIRA_AUTOCREATE_INFO_DEF_VALUE,
        name = JiraConstants.JIRA_AUTOCREATE_BASE_NAME + "Info",
        description = JiraConstants.JIRA_AUTOCREATE_BASE_DESC + "Info", global = true,
        project = true),
    @Property(key = JiraConstants.JIRA_EPIC_TYPE_ID, name = "Epic ID",
        description = "Epic ID to assign Issues to", global = true, project = true,
        module = false)})
public class JiraIssueCreator implements ServerExtension {
  ...
  protected JiraSession createJiraSession(Settings settings) {
    LOG.error("creating REST session");
  ...
  protected BasicIssue doCreateIssue(Issue sonarIssue, JiraSession session, Settings settings) {
    // Connect to JIRA
    ...
    JiraService jiraService = session.getJiraService(ruleFinder, settings);
    String authToken = session.getAuthenticationToken();

    // And create the issue
    BasicIssue returnedIssue = jiraService.createIssue(authToken, sonarIssue);
  ...
  protected BasicIssue sendRequest(JiraService jiraService, String authToken, Issue issue,
      String jiraUrl, String userName) {
    return jiraService.createIssue(authToken, issue);
  }
    ...
    switch (reviewSeverity) {
      ...
      default:
        throw new SonarException(
            "Unable to convert review severity to JIRA priority: " + reviewSeverity);
    }
    return priorityId;
  }
