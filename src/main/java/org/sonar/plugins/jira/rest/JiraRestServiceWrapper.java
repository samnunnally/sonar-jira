...
public class JiraRestServiceWrapper extends BasicJiraService {
    ...
    public BasicIssue createIssue(IssueInput issueInput) {
      return createIssue(jiraRestClient.getIssueClient().createIssue(issueInput));
    }
    ...
    private IssueInput convertIssue(Issue sonarIssue) {
        ...
        builder.setPriorityId(Long.valueOf(sonarSeverityToJiraPriorityId(RulePriority.valueOf(sonarIssue.severity()),super.settings)));
